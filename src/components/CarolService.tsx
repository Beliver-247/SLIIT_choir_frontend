...
export function CarolService() {
  return (
    <section id="carol-service" className="py-20 bg-gradient-to-br from-brand-navy to-brand-indigo text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.45 }}>
            <div className="inline-block bg-white/20 text-white px-4 py-2 rounded-full mb-6 shadow-sm">
            ...
            <p className="text-brand-yellow/90 text-xl mb-8">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-brand-yellow/85">
          ...
          <motion.div className="relative" initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            {/* Stats overlay */}
            <div className="absolute -bottom-6 left-6 right-6 bg-white text-brand-navy p-6 rounded-lg shadow-xl">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl mb-1">1000+</div>
                  <div className="text-brand-navy/70 text-sm">Attendees</div>
                </div>
                <div>
                  <div className="text-2xl mb-1">$50K+</div>
                  <div className="text-brand-navy/70 text-sm">Raised</div>
                </div>
                <div>
                  <div className="text-2xl mb-1">10th</div>
                  <div className="text-brand-navy/70 text-sm">Year</div>
                </div>
              </div>
            </div>
          </motion.div>
