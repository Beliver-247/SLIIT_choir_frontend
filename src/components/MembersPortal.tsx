        ...
        <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-6">
          ...
          <TabsContent value="merchandise" className="space-y-6">
            {showMerchandiseManagement ? (
              ...
              <motion.div className="space-y-4" initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.35 }}>
                <div className="flex">
              ...
              <>
                {isAdmin && (
                  <motion.div className="flex gap-2 justify-end" whileHover={{ scale: 1.01 }}>
