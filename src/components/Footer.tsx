        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="#carol-service" className="text-white/80 hover:text-white transition-colors">
                  Carol Service
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/60 focus:outline-none focus:border-brand-yellow"
              />
              <Button className="w-full bg-white text-brand-navy hover:bg-brand-yellow/10">
                Subscribe
              </Button>
            </div>
          </div>
